...
export class WorkspaceManager{
    ...
    readonly scopedTypesFileName:string = 'ScopedGlideSoft.d.ts';
    readonly legacyTypesFileName:string = 'LegacyGlideSoft.d.ts';
    readonly clientTypesFileName:string = 'ClientGlideSoft.d.ts';
    ...
    */
    ...
    loadSNTypeDefinitions(context:vscode.ExtensionContext){
        ...
        let legacyTypesPath  = path.resolve(rootPath, '@Types', 'GlideSoft', this.legacyTypesFileName + '.inactive');
        let clientTypesPath = path.resolve(rootPath, '@Types', 'GlideSoft', this.clientTypesFileName);
        
        let typesPath = path.resolve(context.extensionPath, 'dist', 'SNDefinitions', 'masterTypes.json');
        let typeData:any = this.loadJSONFromFile(typesPath);
        ...
        this.logger.info(this.lib, func, 'First entry from legay type data: ', typeData.legacy.AbstractDBObject);
